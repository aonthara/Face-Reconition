...
label = Label(frame, text="FaceRecognition",bg='white',font=('Times 38 bold'))
label.pack(side=TOP)
filename = PhotoImage(file="D:\FaceReconition\img\\bl.png")
...
def anotherWin():
   tkinter.messagebox.showinfo("About",'Face Recognition\n Made Using\n-OpenCV\n-Numpy\n-Tkinter\n-Pandas\n-Joblib\n-Matplotlib\n-Sklearn\n-Pygame\n-Time\n-Python 3')
...
but1=Button(frame,padx=5,pady=5,width=30,bg='white',fg='black',relief=GROOVE,command=sa,text='Face-Auto-Save',font=('helvetica 15 bold'))
but1.place(x=55,y=110)

but2=Button(frame,padx=5,pady=5,width=30,bg='white',fg='black',relief=GROOVE,command=ta,text='Face-Trainer',font=('helvetica 15 bold'))
but2.place(x=55,y=180)

but3=Button(frame,padx=5,pady=5,width=30,bg='white',fg='black',relief=GROOVE,command=fa,text='Face-Recognition',font=('helvetica 15 bold'))
but3.place(x=55,y=250)

but5=Button(frame,padx=5,pady=5,width=5,bg='white',fg='black',relief=GROOVE,text='EXIT',command=exitt,font=('helvetica 12 bold'))
